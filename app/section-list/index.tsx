      ...
      <CardThemed>
				<SectionList
					...
					renderSectionHeader={({section}) => (
						<TextThemed typeText='h1' className='bg-light-background dark:bg-dark-background p-2 rounded'>{section.title}</TextThemed>
					)}
					ListFooterComponent={() => (
						<TextThemed typeText='h2' className='font-bold bg-light-background dark:bg-dark-background p-2 mb-10 rounded'>
